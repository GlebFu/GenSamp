...
# # undebug(get_CH)
# 
# save(clusters, chPlot, clust_time, ch_time, K, distance, file =  paste("Paper Data/", file_date, "/clusters-full-logs.rdata", sep = ""))
```
...
save(cls, file =  paste("Paper Data/", file_date, "/Clusters.rdata", sep = ""))
