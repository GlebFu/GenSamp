...
# undebug(get_CH)
save(clusters, distance, file =  "Data/Cluster Analysis/cluster analysis data k2-10.rdata")
save(chPlot, clust_time, ch_time, K, cluster_vars, minK, df.clusters, cluster.vratio, file =  "Data/Cluster Analysis/Clusters k2-10.rdata")
