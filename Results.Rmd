...
df_Bindex <- df_Bindex %>%
  mutate(sample = str_replace(sample, "F", "BS"),
         Rank = str_replace(sample, "SUBS_", ""),
         Clustering = ifelse(str_detect(sample, "SUBS"), "Strat", "None"),
...
if(savePlot) ggsave("Figs/paper B-Index.jpg", dpi = 1000, width = 5, height = 4)
```
...
if(savePlot)  ggsave("Figs/All SMDs.jpg", dpi = 1000, width = 6, height = 5)
```
...
if(savePlot)  ggsave("Figs/Units Contacted.jpg", dpi = 1000, width = 6, height = 5)
