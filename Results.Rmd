...
save(df, df.coefs, intercepts, chPlot, cluster.vratio, minK, prop_allocations, df.clusters, covariates, sSMDplot, file = "Data/Paper/Paper Data.rdata")
...
save(df, df.coefs, intercepts, chPlot, cluster.vratio, minK, prop_allocations, df.clusters, covariates, sSMDplot, samplot,
