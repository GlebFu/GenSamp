...
df_Bindex <- df_Bindex %>%
  mutate(sample = str_replace(sample, "F", "Balanced Sampling"),
         sample = str_replace(sample, "CS", "Convenience Sampling"),
         sample = str_replace(sample, "SRS", "Simple Random Sampling"),
         Sampling = str_replace(sample, "SUBS_", ""),
         Clustering = ifelse(str_detect(sample, "SUBS"), "Stratified", "None"),
         sample = str_replace(sample, "SUBS_", "S_"))
...
if(savePlot) ggsave("Figs/paper B-Index.jpg", dpi = 1000, width = 7•, height = 4)
```
...
if(savePlot)  ggsave("Figs/All SMDs.jpg", dpi = 1000, width = 7, height = 5)
```
...
if(savePlot)  ggsave("Figs/Units Contacted.jpg", dpi = 1000, width = 7, height = 5)
