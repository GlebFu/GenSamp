...
rename_conditions <- function(orig.data) {
  orig.data %>%
  mutate(sample = str_replace(sample, "F", "Balanced"),
         sample = str_replace(sample, "CS", "Convenience"),
         sample = str_replace(sample, "SRS", "Random"),
...
save(avg_Bindex, df_Bindex, sSMDplot, df_responses, samplot, df_sch_smd, file = "Paper Data/Result Data.rdata")
```
