...
df.counts   %>%
  ...
  ggplot() +
  geom_density(aes(x = PS, fill = sample_method, weight = w), alpha = .1) +
  geom_density(data = df.counts.pop %>% filter(RR == filter.rr),
               aes(x = PS),
               linetype = "dashed") +
  facet_grid( ~ Sampling, scales = "free_y")
...
df.counts   %>%
  filter(RR == filter.rr) %>%
  ggplot() +
  geom_density(aes(x = log(n), fill = sample_method, weight = w), alpha = .1) +
  geom_density(data = df.counts.pop %>% filter(RR == filter.rr),
               aes(x = log(n)),
               linetype = "dashed") +
  facet_grid( ~ Sampling, scales = "free_y")
...
df.counts   %>%
  filter(RR == filter.rr) %>%
  ggplot() +
  geom_density(aes(x = log(ethBlack), fill = sample_method, weight = w), alpha = .1) +
  geom_density(data = df.counts.pop %>% filter(RR == filter.rr),
               aes(x = log(ethBlack)),
               linetype = "dashed") +
  facet_grid( ~ Sampling, scales = "free_y")
...
df.counts   %>%
  filter(RR == filter.rr) %>%
  ggplot() +
  geom_density(aes(x = pELL, fill = sample_method, weight = w), alpha = .1) +
  geom_density(data = df.counts.pop %>% filter(RR == filter.rr),
               aes(x = pELL),
               linetype = "dashed") +
  facet_grid( ~ Sampling, scales = "free_y")
