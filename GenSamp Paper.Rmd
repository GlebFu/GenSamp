...
Overall, UCS required the least "effort" to recruit a full sample, followed by URS and SCS, SRS, and finally SBS. 

Figure \@ref(fig:fig-response-rates) plots the response rates of schools approached for recruitment against the population participation rates. As expected, URS response rates reflected those in the population. Both UCS and SCS resulted in higher response rates, while SRS and SBS resulted in lower response rates. 
...
tab.feas %>%
  ...
  facet_wrap( ~ measure, scales = "free_y", ncol = 1, 
                strip.position = "left", 
                labeller = as_labeller(c(sch.contacted = "Units Contacted", sch.response.rate = "Response Rate") ) ) +
  scale_x_continuous(breaks = seq(10, 90, 20)) +
  expand_limits(y = 0) +
...
(ref:fig-comp-caption) Comparisons.
