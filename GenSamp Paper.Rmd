...
```{r fig-comp, fig.pos = "tb", fig.width = 9, fig.height = 7, fig.cap = "Proportionate comparisons of difficulties between models. The straight horizontal line is the focus of comparison in each panel."}
...
(ref:fig-units-contacted-caption) Average number of schools contacted to achieve $N = 60$

```{r fig-units-contacted, results = "asis", fig.cap = "(ref:fig-units-contacted-caption)", eval = F}
