...
To select parameters for the RGM we first defined desireable sample characteristics. @tiptonSiteSelectionExperiments2016 reported as those that resembleed, on average, characteristics 
