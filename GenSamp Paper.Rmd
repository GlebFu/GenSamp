...
(ref:fig-ICCvsCoef-caption) ICC Values vs absolute log_odds. Shaded areas illustrate potential paterns in generalizability measured by SMDs.
...
tabs$ICC.vs.Coefs %>%
  ...
  geom_text_repel(label.padding = 1, point.padding = .2) +
  labs(y = "Log Odds",
       x = "ICC") +
