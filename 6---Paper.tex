...
\end{align}
where \(\sigma_{\pi}\) is the variance of the propensity scores. \todo[color=orange]{Do these equations look right?}\todo[color=blue!20]{Could you point me to the lines in the code?}
