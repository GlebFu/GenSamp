...
# Introduciton
  In education research, multisite randomized trials (MRTs) are commonly used to inform policy decisions by examinig intervention impacts at a large scale. Randomized treatment assignemnt, a gold standard for demonstrating causality, ensures such studies maintain a high level of internal validity. However, policy makers are often interested in generalizing treatment effects to populations that may not always be represented by the units being sampled. Treatment effects of educational interventions are known to vary across study units such as students and schools. As a results researchers must carefully recruit units into the sample that represent the population of interest. In practice, however, researchers often rely on samples of convenience which may lead to biased treatment effect estimates in the population. As a result, the external validity of MRTs has come under scrutiny [@stuartUsePropensityScores2011]. 
