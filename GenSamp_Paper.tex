...
\hypertarget{participation-model}{%
\paragraph{Participation Model}\label{participation-model}}

\hypertarget{sbs}{%
\subsubsection{SBS}\label{sbs}}
...
\paragraph{Distance Metric}\label{distance-metric}}
...
\paragraph{Selecting k Strata}\label{selecting-k-strata}}
...
\hypertarget{other-sampling-schemes}{%
\subsubsection{Other Sampling Schemes}\label{other-sampling-schemes}}
