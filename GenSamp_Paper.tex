...
\hypertarget{stratified-balanced-sampling-1}{%
\subsection{Stratified Balanced Sampling}\label{stratified-balanced-sampling-1}}
...
\begin{figure}
\centering
\includegraphics{GenSamp_Paper_files/figure-latex/ch-full-1.pdf}
\caption{\label{fig:ch-full}Generalizd Calinski-Harabasz index}
\end{figure}

\begin{figure}
\centering
\includegraphics{GenSamp_Paper_files/figure-latex/ratio-full-1.pdf}
\caption{\label{fig:ratio-full}Ratio of between cluster sum of squares to total cluster sum of squares}
\end{figure}

\begin{figure}
\centering
\includegraphics{GenSamp_Paper_files/figure-latex/k-size-full-1.pdf}
