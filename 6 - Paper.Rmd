...
(ref:fig-SMD-group3-caption) Group 3: all methods performed well, with SBS performing slightly better. Dotted horizontal line indicates a .25 cutoff.

```{r fig-SMD-group3, fig.height = 3, fig.cap = "(ref:fig-SMD-group3-caption)"}
...
(ref:fig-SMD-group4-caption) Group 4: poor relative performance for stratified convenience sampling and stratified random sampling. Dotted horizontal line indicates a .25 cutoff.

```{r fig-SMD-group4, fig.height = 3, fig.cap = "(ref:fig-SMD-group4-caption)"}
...
(ref:fig-Var-Coef-caption) ICC Values vs absolute log odds. Shaded areas illustrate potential patterns in generalizability measured by SMDs.
