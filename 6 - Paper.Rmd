...
\JEP{Discuss assumptions behind this model.}\GF{added}\JEP{Discuss difficulty of estimating this model from extant data, due to non-representative samples. Also how will we develop assumptions about values of $\boldsymbol\beta$?}\GF{added}
...
```
\JEP{Couldn't figure out how to get the Figure to the top of the page.} \GF{like this?}
