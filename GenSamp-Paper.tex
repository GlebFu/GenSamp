...
In this section we propose formal models for the sampling procedures to be incorporated in the simulation study. These models are by no means comprehensive, and by formalizing them in this fashion we hope to make them trasnparent, reproducible, and more easily modified to fit other circumstances which may be of interestest for study.
