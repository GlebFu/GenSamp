...
Inadequate sampling strategies are a major threat to generalizability of MRTs. Several studies have found substantial differences between schools and districts that participate in large scale randomized trials (Fellers, 2017; Stuart, Bell, Ebnesajjad, Olsen, \& Orr, 2017). Purposive or non random samples may lead to substantially biased estimates of population level effects (Olsen, Orr, Bell, \& Stuart, 2013; Shadish, Cook, \& Campbell, 2002). Furthermore, if the sample of sites is too small or homogeneous, the scope of the generalization is greatly diminished.
...
Total Students & n & 0.06 & 0.37 & Bad\\
\% Black & ethBlack & 0.06 & 0.29 & Bad\\
Student/Teacher Ratio & ST.ratio & 0.10 & -0.10 & Neutral\\
Total District Schools & dSCH & 0.12 & 0.52 & Very Good\\
