...
\subsection{\texorpdfstring{Sampling Methods\todo[color=blue!20]{This section reads like part of the simulation methods. But we haven't explained the simulation study at all yet.}\todo[color=orange]{Lets discuss}}{Sampling Methods}}\label{sampling-methods}}
...
\end{align}\todo[color=blue!20]{Is this how we determined $h$?}\todo[color=orange]{Lets discuss}
...
\todo[color=blue!20]{Discuss the more detailed figure with cumulative probability plots, or move it to the supplementary materials and note as such.}\todo[color=orange]{I think this should go into supplementary metrials. How should we do that?}
