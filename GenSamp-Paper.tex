...
\todo[color=blue!20]{This section reads like part of the simulation methods. But we haven't explained the simulation study at all yet.}\todo[color=orange]{Lets discuss}
...
where \(\sigma_{\pi}\) is the variance of the propensity scores. \todo[color=orange]{Does this look right? And should it be $\pi_{max}+3h_{max}$?}
...
\todo[color=blue!20]{Discuss the more detailed figure with cumulative probability plots.}
