...
\caption{\label{fig:fig-gini}(ref:fig-gini-caption)}
\end{figure}

\begin{sidewaysfigure}
\includegraphics{GenSamp-Paper_files/figure-latex/fig-gini-curve-1} \caption{(ref:fig-gini-curve-caption)}\label{fig:fig-gini-curve}
\end{sidewaysfigure}
