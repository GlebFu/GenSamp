...
\subsection{Selecting k Strata}\label{selecting-k-strata}}
...
If there is a high degree of homogeneity within strata, this sampling procedure should be fairly robust to moderate non-participation rate. However a very large non-participation rate may result in a lack of balance(Tipton, 2013b). If large differences are detected, post hoc methods described previously can be used to make further adjustments.
...
\begin{verbatim}
## Warning: Column `vnames` joining character vector and factor, coercing into
## character vector
\end{verbatim}
...
\caption{\label{fig:plot-dist1}Distributions of continous covariates.}
\end{figure}
...
\midrule
Total District Schools & dSCH & 0.52\\
\% Black & ethBlack & 0.29\\
\% Hispanic & ethHisp & 0.40\\
\% White & ethWhite & -0.54\\
Total Students & n & 0.37\\
\% ELL & pELL & 0.41\\
\% Female & pFem & -0.02\\
\% FRL & pTotfrl & 0.08\\
...
\begin{figure}
\centering
\includegraphics{GenSamp-Paper_files/figure-latex/fig-intercepts-1.pdf}
\caption{\label{fig:fig-intercepts}Intercepts used to generate response rates}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{GenSamp-Paper_files/figure-latex/fig-ch-1.pdf}
\caption{\label{fig:fig-ch}Generalized Calinski-Harabasz index}
\end{figure}

\begin{figure}
\centering
\includegraphics{GenSamp-Paper_files/figure-latex/fig-ratio-1.pdf}
\caption{\label{fig:fig-ratio}Ratio of between cluster sum of squares to total cluster sum of squares}
\end{figure}

\begin{figure}
\centering
\includegraphics{GenSamp-Paper_files/figure-latex/fig-k-size-1.pdf}
...
Figure \ref{fig:fig-units-contacted} reports the average number of schools that needed to be contacted before a full sample of \(N = 60\) schools was selected. At higher participation rates differences between methods were negligible. However, as participation rates decreased the disparity between the methods became more apparent. Overall, UCS required the least \enquote{effort} to recruit a full sample, followed by URS and SCS, SRS, and finally SBS. Figure \ref{fig:fig-response-rates} plots the response rates of schools approached for recruitment against the population participation rates. As expected, URS response rates reflected those in the population. Both UCS and SCS resulted in higher response rates, while SRS and SBS resulted in lower response rates.
...
\begin{verbatim}
## # A tibble: 13 x 5
##    Variables              vnames     icc log_odds results  
##    <fct>                  <chr>    <dbl>    <dbl> <chr>    
##  1 % Female               pFem     0.001   -0.019 Neutral  
##  2 Total Students         n        0.056    0.374 Bad      
##  3 % Black                ethBlack 0.06     0.291 Bad      
##  4 Student/Teacher Ratio  ST.ratio 0.105   -0.101 Neutral  
##  5 Total District Schools dSCH     0.119    0.52  Very Good
##  6 Town/Rural             ToRu     0.271   -0.403 Good     
##  7 % ELL                  pELL     0.537    0.412 Good     
##  8 Suburban               Suburban 0.581    0.007 Bad      
##  9 % Hispanic             ethHisp  0.664    0.395 Good     
## 10 % White                ethWhite 0.674   -0.538 Very Good
## 11 % FRL                  pTotfrl  0.764    0.081 Good     
## 12 Urban                  Urban    0.91     0.433 Good     
## 13 Schoolwide Title I     T1       0.944    0.019 Good
\end{verbatim}
