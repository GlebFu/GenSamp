...
Overall, UCS required the least \enquote{effort} to recruit a full sample, followed by URS and SCS, SRS, and finally SBS.
...
\caption{\label{fig:fig-comp}Comparisons.}
\end{figure}
